...
void Adjust(){
    ...
    Error_Pitch_A=(Desired_Pitch-(angle_pitch*1.5))-(angle_pitch); // the error is determined by looking at the curreent reading and subttacing the desired value from it.
    Error_Roll_A=(Desired_Roll-(angle_roll*1.5))-(angle_roll);
