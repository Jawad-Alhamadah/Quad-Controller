...
float Integral_gain_A=0.012; //0.02 
float Derivative_gain_A=18.4; //15.3

float PitchTrim=0.01;
float RollTrim=-0.015;

float Porpotional_gain_y=1.5;  //1.5;  //0.2
...
//Serial.print("X: ");Serial.print(RCx);Serial.print("y: ");;Serial.print(RCy);
//Serial.print("z: ");
//Serial.println(RCx);
}
...
Error_Pitch_A+=PitchTrim;
Error_Roll_A+=RollTrim;
